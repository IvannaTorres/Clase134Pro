...
train_data = pd.read_csv("/content/Clase134Pro/static/assets/data_files/tweet_emotions.csv")    
training_sentences = []
...
model = load_model("/content/Clase134Pro/static/assets/model_files/Tweet_Emotion.h5")
